...
void HAL_HCD_MspInit(HCD_HandleTypeDef* hcdHandle)
{
  ...
  if(hcdHandle->Instance==USB_OTG_HS)
  {
    ...
    PB14     ------> USB_OTG_HS_DM
    PB15     ------> USB_OTG_HS_DP // NOT USED, since we're using ULPI
    */
    GPIO_InitStruct.Pin = ULPI_D7_Pin|GPIO_PIN_13|GPIO_PIN_12|ULPI_D3_Pin
...
void HAL_HCD_MspDeInit(HCD_HandleTypeDef* hcdHandle)
{
  if(hcdHandle->Instance==USB_OTG_HS)
  {
    ...
    PB15     ------> USB_OTG_HS_DP // NOT USED, since we're using ULPI
    */
    HAL_GPIO_DeInit(GPIOB, ULPI_D7_Pin|GPIO_PIN_13|GPIO_PIN_12|ULPI_D3_Pin
                          |ULPI_D2_Pin|ULPI_D1_Pin|ULPI_D4_Pin|GPIO_PIN_14
                          /* |GPIO_PIN_15 */);
